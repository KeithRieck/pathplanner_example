...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    swerve.setDefaultCommand(swerve.run(() -> {
      double xspeed = xbox.getLeftX() * 2.0;
      double yspeed = xbox.getLeftY() * -2.0;
      double tspeed = xbox.getRightX() * -Math.PI;
      swerve.driveFieldRelative(new ChassisSpeeds(xspeed, yspeed, tspeed));
    }));
  }
